...
strdbpassword = Request.Form("dbpassword")
...
strdbpassword = replace(strdbpassword,"ABC-WANGOMAIL-ABC",chr(0))
...
'cn.Open "DRIVER={Microsoft Access Driver (*.mdb)}; DBQ=" & Server.MapPath(strdbname)
cn.Open "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & Server.MapPath(strdbname) & ";Jet OLEDB:Database Password=" & strdbpassword & ";","admin", ""
